        ...
        <div className='course'>
            ...
            <div className="content">
                <div className="row">
                    <div className='col'>
                        ...
                        <div className="detail">{detail.courseType}-{detail.id}</div>
                    </div>
                </div>
                <div className="row">
                    <div className="col">
                    ...
                    <div className="col">
                        <div className="field">Ngày khai giảng:<br />Kết thúc:</div>
                        <div className="detail">a{ }<br />a{ }</div>
                    </div>
                    <div className="col">
            ...
            <div className="note">
                ...
                <div className="note-content">
                    {detail.note == "" || detail.note == null? "Không có ghi chú." : note}
                </div>
            </div>
        </div>
    )
