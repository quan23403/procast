  ...
  return (
    <>
      <div className='schedule'>
        <div>
          <DatePicker selected={startDate} onChange={handleStartChange} placeholderText='Start Date' />
          <DatePicker selected={endDate} onChange={handleEndChange} placeholderText='End Date' />
